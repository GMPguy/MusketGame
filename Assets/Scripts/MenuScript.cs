...
public class MenuScript : MonoBehaviour {
    ...
    void Start(){
        ...
        Buttons = new[]{"","laser","smoke","graphics","reload", "thumbstick", "", "sounds",""};
        setupButtons();
    }
        ...
        for(int setB = lv[0]; setB <= lv[1]; setB++){
            switch(Buttons[setB]){
                ...
                case "graphics": 
                    ...
                    break;
                case "thumbstick": ButtonTextes[setB].text = "Flipped thumbsticks - " + (GS.InvertedThumbsticks == 0 ? "No" : "Yes"); break;
    ...
    public void Button(int WhichOne){
        ...
        switch(Buttons[WhichOne]){
            ...
            case "thumbstick": GS.InvertedThumbsticks = (GS.InvertedThumbsticks + 1) % 2; break;
            case "sounds": 
